...
public class GrassPainterWindow : EditorWindow
{
    ...
    public void RemoveAtPoint(RaycastHit[] terrainHit, UnityEngine.Event e)
    {
    ...
    public void AddGrassPainting(RaycastHit[] terrainHit, UnityEngine.Event e)
    {
    ...
    void EditGrassPainting(RaycastHit[] terrainHit, UnityEngine.Event e)
    {
    ...
    void ReprojectGrassPainting(RaycastHit[] terrainHit, UnityEngine.Event e)
    {
        int hits = (Physics.RaycastNonAlloc(ray, terrainHit, 200f, toolSettings.hitMask.value));
        for (int i = 0; i < hits; i++)
